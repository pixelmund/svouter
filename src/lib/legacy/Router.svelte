<script lang="ts">
	...
	import { HISTORY, LOCATION, ROUTER, useLocation, useRouter } from './contexts.js';
	import { globalHistory } from './history.js';
	import { combinePaths, pick } from './utils.js';

	export let basepath: string = '/';
	export let url: string | null = null;
	export let viewtransition: ((direction?: string) => Viewtransition) | null = null;
	...
	const activeRoute = writable<ActiveRoute | null>(null);
	...
	const unregisterRoute = (route: Route) => {
	...
	setContext<RouterContext>(ROUTER, {
		activeRoute,
		base: base as Writable<RouterBase>,
		routerBase: routerBase as Writable<RouterBase>,
		registerRoute,
		unregisterRoute
	});
</script>
